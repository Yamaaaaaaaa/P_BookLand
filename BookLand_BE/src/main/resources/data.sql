...
-- ======================================================
-- BƯỚC 24.1: INSERT bill (Hóa đơn mua hàng)
-- ======================================================
INSERT INTO bill (id, user_id, payment_method_id, shipping_method_id, total_cost, status, payment_status, created_at, updated_at) VALUES
(1, 1, 3, 1, 155000, 'COMPLETED', 'PAID', NOW(), NOW()),
(2, 2, 1, 2, 285000, 'COMPLETED', 'PAID', NOW(), NOW());

-- ======================================================
-- BƯỚC 24.2: INSERT bill_book (Chi tiết hóa đơn)
-- ======================================================
INSERT INTO bill_book (bill_id, book_id, price_snapshot, quantity) VALUES
(1, 2, 130000, 1),
(2, 1, 120000, 1),
(2, 93, 26000, 1),
(2, 8, 25000, 1);
...
-- ======================================================
INSERT INTO book_comment (book_id, user_id, bill_id, comment, rating, created_at) VALUES
(1, 2, 2, 'Sách rất hay, con tôi rất thích!', 5, '2024-12-12 20:00:00'),
(93, 2, 2, 'Truyện cảm động, đọc mà rơi nước mắt', 5, '2024-12-15 18:30:00'),
(8, 2, 2, 'Doraemon luôn là số 1 trong lòng tôi', 5, '2025-01-05 14:20:00'),
(2, 1, 1, 'Harry Potter phần 2 cũng hấp dẫn không kém phần 1', 4, '2024-11-20 10:00:00');
